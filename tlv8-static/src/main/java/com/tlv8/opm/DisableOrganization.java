...
public class DisableOrganization extends ActionSupport{
	...
	@ResponseBody
	@RequestMapping(value = "/disableOrganization", produces = "application/json;charset=UTF-8", method = RequestMethod.POST)
	public Object execute() throws Exception {
		data = new Data();
		String r = "";
		String m = "success";
		String f = "false";
		String sql = "update SA_OPOrg  set SVALIDSTATE='0' where SID = ? or SPARENT = ? or SFID like ?";
