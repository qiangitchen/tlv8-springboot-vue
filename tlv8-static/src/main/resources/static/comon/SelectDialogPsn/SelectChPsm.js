...
var $maingridview;
var currentognid= tlv8.Context.getCurrentOgnID();
...
$(function() {
	...
	var filter = "SFID like '" + tlv8.Context.getCurrentOgnFID() + "%'";
...
function bodyresizeFn() {
	$("#maingridview_grid_label").fixTable({
		fixColumn : 0,// 固定列数
		fixColumnBack : "#ccc",// 固定列数
		width : $("#maingridview_body_layout").width(),// 显示宽度
		height : $("#maingridview_body_layout").height()
	});
}