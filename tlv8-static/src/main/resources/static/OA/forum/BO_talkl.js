...
//发帖
function openview(){
	tlv8.portal.openWindow("创建发帖","/OA/forum/BO_entryPublish.html?tabID="+tlv8.portal.currentTabId(),null);
}
function callBackFn(){
	currentgrid.refreshData();
}
...
function QueryDetailAction(){
	var rowid=currentgrid.getCurrentRowId();
	tlv8.portal.openWindow("帖子浏览","/OA/forum/velocityentry.html?rowid="+rowid+"&title="+name,null);
}
