...
$(document).ready(function(){
	...
	$("#" +$maingridview[0].id+ "_insertItem").click(function(){
		tlv8.portal.openWindow("新增讨论区",
			"/OA/forum/BO_blogadd.html?tabID="+tlv8.portal.currentTabId(),null);
	});
...
tlv8.portal.openWindow("管理","/OA/forum/BO_entry.html?gridrowid="+ rowid+"&name="+name,null);
}
function callBackFn(){
...
function editOrgData(event) {
	...
	tlv8.portal.openWindow("管理","/OA/forum/BO_entry.html?gridrowid="+ event.CurrentRowId+"&name="+name,null);
