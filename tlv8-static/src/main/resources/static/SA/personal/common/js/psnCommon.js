...
var ListTable = function(headArray, tablePos, p, k) {
	...
	function _getheadHtml(clomune) {
		...
		return "<td width=\""
				...
				+ html
				+ "<img style='display:none;'width=\"11\" height=\"10\" border=\"0\" src=\"/SA/personal/EMail/imags/bottonImags/arrow_up.gif\"></td>";
	}
	/*
	 * 得到td数据
	 * @param {Object} row
	...
	function _intil() {
		var htmlk = "<div style=\"display: block; position: absolute; left: 300px; top: 200px;\" id=\"msgArea\"> "
				+ "<img align=\"absMiddle\" src=\"/comon/image/loading.gif\"></div>";
		$("#" + _divId).append(htmlk);
		_setHead();
	}
	_intil();
