...
@Controller
@Scope("prototype")
public class LoadRecvMail extends ActionSupport {
	...
	public Object execute() throws Exception {
		...
		String sql = "SELECT FID,FQUREY,FSENDDEPT,FEMAILNAME,FSENDPERNAME,FSENDTIME,'this_week' AS WEEK,FCOLLECT FROM OA_EM_RECEIVEEMAIL  WHERE FCONSIGNEEID = '"
		...
		try {
			String csql = "SELECT FID FROM OA_EM_RECEIVEEMAIL WHERE FCONSIGNEEID = '" + con.getCurrentPersonID() + "'";
