...
public class SaOpPermissionServiceImpl implements SaOpPermissionService {
	...
	@Override
	public List<SaOpPermission> selectByRoleMenu(String spermissionroleid, String smenuid) {
	...
	@Override
	public int deleteByRoleMenu(String spermissionroleid, String smenuid) {
		Map<String, String> param = new HashMap<>();
		param.put("spermissionroleid", spermissionroleid);
		param.put("smenuid", smenuid);
		return saOpPermissionMapper.deleteByRoleMenu(param);
	}
}
