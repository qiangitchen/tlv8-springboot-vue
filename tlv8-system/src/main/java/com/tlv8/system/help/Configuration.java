...
public final class Configuration {
	...
	private static void loadxml(Properties ctxProp) {
		SAXReader saxreader = new SAXReader();
		try {
			Resource resource = new ClassPathResource(propertyxml);
	...
	public static void processConfiguration() throws IllegalStateException {
		loadxml(ctxProp);
		try {
