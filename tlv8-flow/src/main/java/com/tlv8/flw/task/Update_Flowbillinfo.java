...
public class Update_Flowbillinfo extends ActionSupport {
	...
	public String setaction(String tablename, String fid, String billitem) throws Exception {
		String result = "";
		String custercode = "";
		String custername = "";
		String fbillcode = "";
		...
		String sql = "select " + billitem + " from " + tablename + " where fid = '" + fid + "'";
		String tsql = "select fMAKERNAME from " + tablename + " where fid ='" + fid + "'";
		String upsql = "";
		String nmsql = "";
		String upmsql = "";
		...
		try {
			...
			try {
				...
				if (!rs.next()) {
					...
					System.out.println(custercode + "-" + custername + "-" + fbillcode);
					upsql = "update dysys.sa_task set sProjectName ='" + custercode + "',sCustomerName ='" + custername
							+ "',sPlanName ='" + fbillcode + "' where sdata1 = '" + fid + "'";
					nmsql = "update dysys.sa_task set sname = sname||'[" + custercode + "," + custername + ","
							+ fbillcode + "]' where sdata1 = '" + fid + "' and sname not like '%[%'";
					...
					try {
						...
						if (!rs.next()) {
							...
							upmsql = "update dysys.sa_task set SFMAKERNAME ='" + fmakername + "' where sdata1 = '" + fid
									+ "'";
