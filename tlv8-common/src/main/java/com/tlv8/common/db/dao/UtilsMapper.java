...
public class UtilsMapper {
	...
	public static String delete = "com.tlv8.common.db.mapper.UtilsMapper.deleteSQL";
	public static String update = "com.tlv8.common.db.mapper.UtilsMapper.updateSQL";
