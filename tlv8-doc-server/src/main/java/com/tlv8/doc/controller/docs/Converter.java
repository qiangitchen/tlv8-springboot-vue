...
public abstract class Converter {
	...
	protected void finished() {
		...
		sendToOutputOrNot(String.format(SAVING_FORMAT, prevProcessTook,
				timeTaken));
	}
	...
	protected boolean isChinese(String familyName) {
		return (familyName.equals("隶书") || familyName.equals("宋体")
				|| familyName.equals("微软雅黑") || familyName.equals("黑体")
				|| familyName.equals("楷体") || familyName.equals("新宋体")
				|| familyName.equals("华文行楷") || familyName.equals("华文仿宋")
				|| familyName.equals("宋体扩展") || familyName.contains("宋")
				|| familyName.equals("幼圆") || familyName.equals("华文宋体")
				|| familyName.equals("华文中宋") || familyName.equals("华文行楷")
				|| familyName.equals("楷体_GB2312") || familyName.contains("方正")
				|| familyName.contains("简") || familyName.contains("中"));
	}
